...
export default function ExportAnnualSummary({ planName, invoices, defaultCard }: Props) {
	...
	async function handleExport() {
		...
		try {
			...
			doc.setFontSize(10);
			doc.setFont("helvetica", "bold");
			doc.text(`Total: ${fmt(totalCents)}`, pageWidth - 14, y, { align: "right" });
			y += 12;
			...
			doc.setFont("helvetica", "normal");
			doc.setTextColor(120);
			const note = "This summary is for informational purposes only and is not a tax document. Payment methods are tokenized; full card numbers are never stored. Contact support for invoice disputes or VAT/GST adjustments.";
